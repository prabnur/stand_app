cd X:\Code\stand_app\Production
x:
flutter build appbundle
copy /y X:\Code\stand_app\Production\build\app\outputs\bundle\release\app-release.aab X:\Code\_Builds\stand_app\app-release.aab
cd X:\Code\_Builds\stand_app
